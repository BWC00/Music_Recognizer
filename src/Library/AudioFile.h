 ...
 * │                   UAntwerpen                   │
 * │                  LIBRARY FILE                  │
 * │ SOURCE: https://github.com/adamstark/AudioFile │
 * ╘════════════════════════════════════════════════╛
 * ```
 * @file AudioFile.h
 * @author Adam Stark
...
//=============================================================
/** Represents a loaded audio file object. */
template <class T>
class AudioFile
{
public:
    ...
    //=============================================================
    /** Typedefinition to match std::vector<std::vector<T> > to AudioBuffer */
    ...
    /** @return the number of audio channels in the buffer */
    ...
    /** @return the bit depth of each sample */
     ...
     * @return true if the buffer was copied successfully.
     */
...
//=============================================================
/**
 * An enumeration of wave file audio formats.
 */
enum WavAudioFormat
{
    PCM = 0x0001,
...
//=============================================================
/**
 * An enumeration of AIFF audio file formats, and some others.
 */
